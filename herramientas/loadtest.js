...
console.log(
  "\nListo. Si algún escenario muestra errores/timeouts/no-2xx > 0, o la latencia p99 se dispara, " +
    "es la señal para revisar el pool de Postgres (bd/pool.js), los rate limiters " +
    "(src/intermediarios/rateLimit.js) o el tamaño de instancia antes de desplegar a producción."
);
