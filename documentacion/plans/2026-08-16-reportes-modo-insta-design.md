...
- Middleware `requerirSesion` (nuevo, en `src/intermediarios/`) que valida el JWT,
...
- `utilidades/api.js`: `apiFetch` gana modo autenticado (header `Authorization` cuando
